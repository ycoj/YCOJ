...
- [Problem detail, actions, submission, hacking, and statistics](problem-detail-submit.md): includes asynchronous HTML-to-Markdown submission (HTTP 202) and GET `/p/:pid/html-to-markdown/:jobId` polling; submission and hack contest context validates `tid` from query or body parameters
