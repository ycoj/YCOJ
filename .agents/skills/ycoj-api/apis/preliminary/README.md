...
- [Endpoint contracts](endpoints.md): paper/history lists, paper detail (including the referenced programming-problem `pdict`), create/edit/publish, submission, review, and deletion.
